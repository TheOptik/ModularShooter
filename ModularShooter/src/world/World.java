...
public class World {
	...
	public static final double SPAWN_PERCENTAGE = 80;
	...
	static {
		...
		PROTAGONIST.addModule(new BasicWeapon(new Coordinates(-1, 0), PROTAGONIST));
		PROTAGONIST.addModule(new SenturyModule(new Coordinates(0, 2), PROTAGONIST));
		PROTAGONIST.addModule(new SenturyModule(new Coordinates(0, -2), PROTAGONIST));
		PROTAGONIST.addModule(new SenturyModule(new Coordinates(2, 0), PROTAGONIST));
		PROTAGONIST.addModule(new SenturyModule(new Coordinates(-2, 0), PROTAGONIST));
